...
export default function HomePage() {
    return (
        <section id="inicio" className="relative min-h-screen bg-[#0b0602] text-[#f1ece3] flex items-center pt-4 pb-12 overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#0b0602] via-transparent to-[#0b0602]/40" />      </div>
